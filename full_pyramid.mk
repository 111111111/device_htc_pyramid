...
# gsm config xml file
#PRODUCT_COPY_FILES += \
#    device/htc/pyramid/spn-conf.xml:system/etc/spn-conf.xml \
#    device/htc/pyramid/voicemail-conf.xml:system/etc/voicemail-conf.xml
...
#    device/htc/pyramid/modules/sequans_sdio.ko:system/lib/modules/sequans_sdio.ko \
#    device/htc/pyramid/modules/spidev.ko:system/lib/modules/spidev.ko  \
#    device/htc/pyramid/modules/lcd.ko:system/lib/modules/lcd.ko

#PRODUCT_COPY_FILES += \
#    device/htc/pyramid/firmware/bcm4329.hcd:system/etc/firmware/bcm4329.hcd \
#    device/htc/pyramid/firmware/default.acdb:system/etc/firmware/default.acdb \
#    device/htc/pyramid/firmware/default_org.acdb:system/etc/firmware/default_org.acdb
